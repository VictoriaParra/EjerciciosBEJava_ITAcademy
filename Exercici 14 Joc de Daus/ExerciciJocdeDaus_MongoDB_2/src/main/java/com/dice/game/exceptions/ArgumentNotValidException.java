...
/**
 * Esta clase crea una excepción personalizada para que cuando en el request/body
 * se pase un argumento no valido, lance un mensaje específico y así el usuario
 * sepa el motivo por el cual no es valido.
 * 
