...
public class PicturesController {
	...
	public ResponseEntity<Pictures> addPictureToShop(@PathVariable(name = "id") int id, @RequestBody Pictures picture)
		...
		/*
		 * "newPicture.setEntry_date(picture.getEntry_date());" -> no hace falta ya
		 * que esta columna esta marcada como: "insertable = false" y por defecto nos
		 * dara la fecha de hoy.
		 */
